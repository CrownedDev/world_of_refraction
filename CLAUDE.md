...
## Working principles
-  **ALWAY Create a new branch for every new session — never build directly on `main` or an unrelated working branch. Use descriptive prefixes (`feature/`, `refactor/`, `chore/`, `fix/`).**
