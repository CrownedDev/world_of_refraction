...
The **Resonator** is the **ring caster** — a spellcaster whose magic comes entirely from the
**rings** they wear. They **switch elements freely** by swapping rings, which makes them the
**most flexible** archetype — but their rings **wear and break**, which makes them the **most
fragile**.
...
A Resonator's energy pool is **dormant until they're armed.** A ring-only Resonator with **no
weapon and no evolution** has nothing to spend energy *on*, so their energy stays inactive —
**you need a weapon or an evolution to actually use your energy.** Equip one and the pool comes
alive.

## Signature — flexibility at a price
