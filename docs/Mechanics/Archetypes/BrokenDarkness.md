...
## Becoming Broken Darkness

There are two ways to be Broken Darkness:

- **Born to it** — some characters simply *are* Broken Darkness from the start.
- **Breaking** — a Darkness caster who pushes past their stat requirements can break mid-combat
  and transform. (When this happens is largely system-driven — it triggers off overreaching
  casts, not a button you press.)

Either way, you start your Broken Darkness life on your **base Darkness** — ready to cast your
Darkness pool immediately, no setup needed.

## The active pool — one element at a time

This is the core of the form: you channel **exactly one element at a time**, your *active pool*.

- Your **base** is **Darkness** — you always start here.
- When you **absorb** an element (by successfully defending against an attack of that element —
  see *Absorption* below), your active pool **rotates** to that element. Absorb Fire and you now
  cast Fire (as "Dark Fire"); absorb Wind and you rotate to Wind; and so on.
- The pool you rotated away from goes **dormant** — you can't cast it until you rotate back.
- **Absorbing Darkness** rotates you back to your base Darkness pool.

So you're always wielding one element — your most recent absorption — and switching is a matter
of absorbing something new. Choose what you defend against, and you choose what you can cast.

## Absorption (building energy)

Absorbing is also how a Broken Darkness character **fuels** their casting: defending well against
an attack converts its energy into your pool. Absorbing is therefore two things at once —
it **rotates** your active element *and* **builds** your energy.
...
Broken Darkness is **near-black** — your true colour is darkness. Your **active pool tints that
black**:

- Base **Darkness** → pure near-black.
- Absorbed **Fire** → darkened red. **Wind** → darkened green. **Water** → darkened blue. And so
  on — every element shows as a *darkened* version of itself.

Your energy bar and your spells reflect the active pool's colour live — rotate to a new element
and everything re-tints. Spells read as **"Dark [Element]"** (Dark Fire, Dark Wind), with two
