...
#include "LoadoutConstants.h" // Reference existing constants
...
namespace InventoryConstants
{
    ...
    inline int32 GetItemCapacityForTier(int32 TierIndex)
    {
        switch (TierIndex)
        {
            case 0: return ITEM_CAPACITY_F; // F_Tier
            case 1: return ITEM_CAPACITY_E; // E_Tier
            case 2: return ITEM_CAPACITY_D; // D_Tier
            case 3: return ITEM_CAPACITY_C; // C_Tier
            case 4: return ITEM_CAPACITY_B; // B_Tier
            case 5: return ITEM_CAPACITY_A; // A_Tier
            case 6: return ITEM_CAPACITY_S; // S_Tier
            default: return 0;
        }
    }
    ...
    {
        if (bIsEvolved) return WEAPON_EVOLUTION_SLOT_COST;
        if (bHasCrystal) return WEAPON_CRYSTAL_SLOT_COST;
