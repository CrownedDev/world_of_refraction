 ...
 *
 * Display: actor name, turn number, active/inactive state.
 * BP handles the active/inactive visual difference (color tint, scale, etc.).
 */
UCLASS(Abstract)
...
public:
	...
	void InitialiseSlot(AActor *InActor, int32 InTurnNumber, bool bIsActive);
